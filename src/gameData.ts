...
export const MAGICK_ITEMS = {
  Swords: [
    { key: "A", name: "Ascalon", text: "성 조지의 전설적인 검. 이 용을 무찌른 무기는 비술이나 요정에 의해 물리적인 수단으로 파괴되거나 형태가 바뀔 수 없습니다." },
    { key: "2", name: "Balmung", text: "영웅 시구르드의 검. 이 검으로 입힌 부상은 일반적인 수단으로 치유될 수 없습니다. 치유하려면 비술이나 요정의 마법이 필요합니다." },
    { key: "3", name: "Caladbolg", text: "무지개 빛 섬광을 뿜어내는 양손검. 결의를 1점 소비하면 휘두를 때마다 3칸 내의 모든 대상에게 부상을 1점씩 입힙니다." },
    { key: "4", name: "Curtana", text: "자비의 검. 날 끝이 무딘 형태로 되어 있습니다. 착용자는 결의를 1점 소비하여 상대에게 치명적인 일격을 가하는 대신 상대를 기절시킬 수 있습니다." },
    { key: "5", name: "Durendal", text: "천사가 기사 롤랑에게 전해준 부러지지 않는 예리한 검. 이 무기를 휘두르는 한, 적은 어떠한 갑옷(AP)으로도 부상을 줄일 수 없습니다." },
    { key: "6", name: "Excalibur", text: "눈부신 빛을 내뿜어 적을 현혹하는 검. 결의를 1점 소비하여 주변 3칸 내 모든 눈을 가진 적의 공격 판정에 -3 불이익을 줍니다." },
    { key: "7", name: "Gram", text: "나무 기둥에 박혀 있던 것을 뽑아낸 전설의 용살검. 괴수나 고대 존재(드래곤 등)에게 두 배의 부상을 입힙니다." },
    { key: "8", name: "Joyeuse", text: "하루에 서른 번씩 색이 변하는 샤를마뉴 대제의 애검. 소지자는 하루에 한 번 판정 결과를 보기 전에 결의 소비 없이 판정에 +3 보너스를 받습니다." },
    { key: "9", name: "Lobera", text: "늑대 사냥꾼의 검. 착용자가 야수(Beast) 계열 몬스터와 전투를 치를 때 결의 1점을 소비하면 추가 공격 기회를 즉시 얻습니다." },
    { key: "10", name: "Mistilteinn", text: "겨우살이 나뭇가지로 깎아 만든 마법의 검. 무쇠 갑옷에 면역인 요정(Fey) 크리처에게 부상을 입힐 때 +2점의 추가 부상을 가합니다." },
    { key: "P", name: "Orna", text: "스스로 칼집에서 나와 말을 하며 싸우는 검. 착용자가 기절하거나 쓰러졌을 때, 이 검이 스스로를 공중에 띄워 주인 주변 1칸 내 적들을 물리적으로 위협하거나 공격합니다." },
    { key: "Kn", name: "Tizona", text: "겁쟁이를 알아보는 검. 착용자가 결의 1점을 소비하여 검을 뽑아 휘두르면, 상대방 몬스터는 즉시 사기(Morale) 판정을 수행해야 합니다." },
    { key: "Q", name: "Tyrfing", text: "뽑을 때마다 누군가의 피를 보아야만 칼집에 거둘 수 있는 저주받은 검. 사용 시 항상 성공하지만, 검을 거둘 때 반드시 결의 1점이나 부상 1점을 입어야 합니다." },
    { key: "K", name: "Zulfiqar", text: "끝이 두 갈래로 갈라진 명검. 결의를 1점 소비하면 이번 공격의 피해가 두 배가 되거나 동시에 두 대상을 타격합니다." }
  ],
  Coins: [
